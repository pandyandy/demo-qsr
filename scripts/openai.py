            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "REVIEW_CONTEXT_PRICE: Price range mentioned in the review. "
                        ...
                        "REVIEW_ORIGIN: Source of the review (e.g., platform or app). "
                        "OVERALL_SENTIMENT: Sentiment analysis result for the feedback (e.g., positive, negative). "
                        "ADDRESS/STREET/CITY/STATE/POSTAL_CODE/COUNTRY_CODE: Location details of the place."
